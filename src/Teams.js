...
class Teams extends Component {
    ...
    render() {
        return (
            <div className="row">
                <div className="col-12 col-md-4 team-wrapper text-center">
                ...
                <div className="col-12 col-md-4">
                    <div className="row">
                        <div className="col-4 team-score">
                            <span className={"badge " + (this.props.finalized ? 'badge-secondary' : 'badge-danger active')} onClick={(e) => this.changeScore(0, e)}>{this.props.teams[0].score}</span>
                        </div>
